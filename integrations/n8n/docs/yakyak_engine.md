...
| **Generation poll** | Generation progress · settled? · IF · Wait 15s | Patch: polls `get-movie-scene-progress` until no stage is mid-flight (skipped when nothing changed). Episode: polls until the screenplay execution completes. |
